 ...
 *
 * @wordpress-plugin
 * Plugin Name: ICEPAY WP eCommerce Payment Module
 * Plugin URI:  https://github.com/ICEPAY/WP-eCommerce
 * Description: Enables ICEPAY payments within WP eCommerce
 * Version:     2.0.2
 * Author:      ICEPAY B.V.
...
class ICEPAY extends wpsc_merchant {
    ...
    public function setPaymentMethods()
    {
        ...
        foreach ($filteredPaymentMethods as $paymentMethod) {
            ...
            $image = $this->pluginURL . "/assets/images/". strtolower($paymentMethod['PaymentMethodCode']) .".png";
